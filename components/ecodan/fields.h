...
DEFINE_FIELD(mix_tank_feed_temp, 0x0d, 6, VarType_TEMPERATURE);
DEFINE_FIELD(mix_tank_feed_temp_signed, 0x0d, 8, VarType_ONE_BYTE_TEMPERATURE);
DEFINE_FIELD(mix_tank_return_temp, 0x0d, 9, VarType_TEMPERATURE);
DEFINE_FIELD(mix_tank_return_temp_signed, 0x0d, 11, VarType_ONE_BYTE_TEMPERATURE);
DEFINE_FIELD(unknown_temp_1, 0x0e, 6, VarType_TEMPERATURE);
DEFINE_FIELD(unknown_temp_2, 0x0e, 9, VarType_TEMPERATURE);
DEFINE_FIELD(unknown_temp_3, 0x0e, 12, VarType_TEMPERATURE);
